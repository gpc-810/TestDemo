package com.demo.test.hotfix.util;
...
public class FixDexUtils {
    ...
    public static void deleteFixedDex(Context context){
        if(context == null){
            return ;
        }
        //遍历所有的修复的dex
    ...
    private static void inject(PathClassLoader pathLoader, DexClassLoader classLoader) throws Exception {
        //3.合并
...
//        Object dexElements = combineArray(dexObj,pathObj);
